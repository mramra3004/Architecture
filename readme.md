...
public sealed class UserApplicationService : IUserApplicationService
{
    ...
    public async Task<IDataResult<long>> AddAsync(AddUserModel addUserModel)
    {
        ...
        var signModel = _signService.CreateSign(addUserModel.SignIn);

        var userEntity = UserFactory.Create(addUserModel, signModel);
    ...
    public async Task<IDataResult<TokenModel>> SignInAsync(SignInModel signInModel)
    {
        ...
        validation = _signService.Validate(signModel, signInModel);
        ...
        var tokenModel = _signService.CreateToken(signModel);
...
public sealed class UserConfiguration : IEntityTypeConfiguration<UserEntity>
{
    public void Configure(EntityTypeBuilder<UserEntity> builder)
    {
        ...
        builder.OwnsOne(x => x.Sign, y =>
        {
            ...
            y.Property(x => x.Password).HasColumnName(nameof(UserEntity.Sign.Password)).IsRequired().HasMaxLength(500);
